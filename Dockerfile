...
RUN python3 -m pip install setuptools==67.6.1
RUN python3 -m pip install wheel==0.40.0
RUN python3 -m pip install torch==2.0.0+cu118 torchvision==0.15.1+cu118 torchaudio==2.0.1+cu118 --index-url https://download.pytorch.org/whl/cu118
RUN python3 -m pip install lightning==2.0.1
...
RUN python3 -m pip install optuna==3.1.1
RUN python3 -m pip install tqdm==4.65.0

RUN python3 -m pip install pandas==2.0.0
RUN python3 -m pip install polars==0.17.1
...
RUN python3 -m pip install mlflow==2.2.2
RUN python3 -m pip install boto3==1.26.110
RUN python3 -m pip install wandb==0.14.2
...
RUN python3 -m pip install pytorch-metric-learning==2.1.0
...
RUN python3 -m pip install kornia==0.6.11
RUN python3 -m pip install kornia-moons==0.2.4
