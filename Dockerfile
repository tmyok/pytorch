...
RUN python3 -m pip install --no-cache-dir setuptools==67.8.0
RUN python3 -m pip install --no-cache-dir wheel==0.40.0
...
RUN python3 -m pip install --no-cache-dir lightning==2.0.3
RUN python3 -m pip install --no-cache-dir opencv-python==4.7.0.72
...
RUN python3 -m pip install --no-cache-dir pandas==2.0.2
RUN python3 -m pip install --no-cache-dir polars==0.18.2
RUN python3 -m pip install --no-cache-dir lightgbm==3.3.5

RUN python3 -m pip install --no-cache-dir scikit-learn==1.2.2
RUN python3 -m pip install --no-cache-dir scikit-image==0.21.0
RUN python3 -m pip install --no-cache-dir scipy==1.10.1

RUN python3 -m pip install --no-cache-dir matplotlib==3.7.1
RUN python3 -m pip install --no-cache-dir seaborn==0.12.2

#RUN python3 -m pip install --no-cache-dir mlflow
RUN python3 -m pip install --no-cache-dir boto3==1.26.153
RUN python3 -m pip install --no-cache-dir wandb==0.15.4

RUN python3 -m pip install --no-cache-dir grad-cam==1.4.6
...
RUN python3 -m pip install --no-cache-dir openmim==0.3.7
RUN mim install mmcv-full
RUN python3 -m pip install --no-cache-dir mmcls==0.25.0
RUN python3 -m pip install --no-cache-dir mmdet==3.0.0
RUN python3 -m pip install --no-cache-dir mmsegmentation==1.0.0

RUN python3 -m pip install --no-cache-dir faiss-gpu==1.7.2
RUN python3 -m pip install --no-cache-dir pytorch-metric-learning==2.1.2

RUN python3 -m pip install --no-cache-dir e2cnn==0.2.3
RUN python3 -m pip install --no-cache-dir einops==0.6.1
RUN python3 -m pip install --no-cache-dir h5py==3.8.0
RUN python3 -m pip install --no-cache-dir imutils==0.5.4
RUN python3 -m pip install --no-cache-dir kornia==0.6.12
...
RUN python3 -m pip install --no-cache-dir pydicom==2.4.0
...
RUN python3 -m pip install --no-cache-dir onnxruntime==1.15.0
RUN python3 -m pip install --no-cache-dir onnxsim==0.4.31

RUN python3 -m pip install --no-cache-dir transformers==4.30.2
RUN python3 -m pip install --no-cache-dir datasets==2.13.0
...
RUN python3 -m pip install --no-cache-dir jsonschema==4.17.3
...
RUN python3 -m pip install --no-cache-dir -U timm==0.9.2
